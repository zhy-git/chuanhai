        ...
        <div class="periods0 fl">
            ...
            <div class="periods_more" rel_n="areaId" rel_v="" style="width:200px;">
              ...
              <?php 
                ...
                ?>
 <div selected = "selected"  class="p_m_items" rel="<?php echo $cityall['id'];?>" bmapx="<?php echo $cityall['zbx'];?>" bmapy="<?php echo $cityall['zby'];?>" jup="y" style="float:left; width:33.33%; padding:0; margin:0; text-align:center;"><?php echo $cityall['city_name'];?></div>
<?php }?>
...
<script type="text/javascript">
var g_bmapx = 109.195233; var g_bmapy = 21.507552; var g_bmapz = 10;
