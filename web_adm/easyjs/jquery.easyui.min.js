...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"当前 {from} 到 {to} 条,共 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
},message:"请输入长度{0} 到 {1}个字符之间."},remote:{validator:function(_450,_451){
var data={};
data[_451[1]]=_450;
...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_8a2,keydown:_8a6,paste:_8a6,drop:_8a6},panelWidth:null,panelHeight:80,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
