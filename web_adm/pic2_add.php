...
<body>
<div class="nav_guide">当前位置：楼盘相册管理 &gt; 楼盘[<font color="#0099FF" style="font-size:16px;"><?php echo $lpname;?></font>]户型<?php
$rowp=$mysql->query("SELECT * FROM `web_pic` WHERE `id`='{$pic_id2}'");
echo '['.$rowp[0]['pic_name'].']图片添加';

?>
	<div class="cus_search2"><a href="pic_edit.php?id=<?php echo $pic_id2;?>" class="back">返回户型相册列表</a></div>
</div>
<div class="content2">
...
function thisMovie(movieName){   
  if(isMSIE){   
	...
	<div style="width:408px; height:348px; position:absolute; top:10px; left:10px;"><div style="background:#DCE5F1; border:#5576B8 solid 1px; font-size:12px; line-height:22px; text-align:left;">
      ...
      <select id="select2" name="select2" style="position:absolute; top:0px; left:172px;">
    
	    <option value="<?php echo $pic_id2;?>">户型[<?php echo $rowp[0]['pic_name'];?>]</option>
