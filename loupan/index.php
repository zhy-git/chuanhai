...
.ad2-ul li{width: 475px;float: left;margin-right: 10px;}
.ad2-ul li img{width: 475px;height: 212px;}
.w240{width: 240px;}
.ad2-ul{width: 1174px;}
...
<div class="w1200" style="overflow: hidden; padding-top:20px;">
	...
	<div class="fl" style="width: 960px;">
		<ul class="ad2-ul">		
         <?php
				$row = $mysql->query("select * from `web_link` where `ad_id`='39'  and `city_id`='{$city_id}' order by px asc limit 0,2");
				foreach($row as $k=>$list){
				?>
               <li><a href="<?php echo $list['link_url'];?>" target="_blank"><img src="/<?php echo $list['img'];?>" alt="<?php echo $list['title'];?>"></a></li>
