...
$dataa = $list['id']; $num += count($dataa);?>
  ...
  ?>
  {"page":{"rowCount":<?php echo $num;?>,"page":1,"next":2,"last":15,"pageSize":10,"pageCount":10,"first":0,"previous":0},"items":[
<?php
$key=$_GET['key'];
$pid=9;
$page = isset($_GET['page']) ? intval($_GET['page']) : 1;
...
?>
{"mapY":<?php if($list['zby']==""){ echo "20.006282";}else{ echo $list['zby'];}?>,"mapX":<?php if($list['zbx']==""){ echo "110.196169";}else{ echo $list['zbx'];}?>,"model":[{"roomCh":"二","count":<?php echo $key+1;?>,"room":2}],"phone":"<?php echo telsee($list['loupan_tel']);?>","price":{"houseUse":"<?php echo cityname($list['city_id']);?>","buildingTypeId":4,"price":<?php echo $list['jj_price'];?>.0,"priceUnitOther":"均价","deputy":1,"priceType":1,"priceSearch":<?php echo $list['qj_price'];?>.0,"showPrice":1,"buildingType":"高层","rentSale":3,"showSumPrice":0,"priceUnit":"元/㎡","totalPriceSearch":-1.0,"houseUseId":6},"urlShort":"http://XXX/","floor":"<?php echo $list['title'];?>","issueId":<?php echo $list['id'];?>,"sellSchedule":2,"appraiseCount":0,"photoCount":0,"modelCount":0,"photo":"/<?php echo $list['img'];?>","url":"http://XXX"}<?php if($numm==$num){}else{ echo ",";}?>
  <?php
		}
		}
  ?>
