  ...
  function initFeatureSlide2(strId) {
    ...
    var domRoot = document.getElementById('feature-slide-block'+strId);
    ...
    var domList = document.getElementById('feature-slide-list-items'+strId);
    ...
    var domPreviousBtn = document.getElementById('feature-slide-list-previous'+strId);

    var domNextBtn = document.getElementById('feature-slide-list-next'+strId);



    //long

    var domHuan = document.getElementById('feature-slide-list-huan'+strId);

  var domFangchanquan = document.getElementById('feature-slide-list-fangchanquan'+strId);
  ...
  if(domFangchanquan != null){
      ...
      var fangChanQuanUrl = $("#feature-slide-list-fangchanquan"+strId).attr("href");
