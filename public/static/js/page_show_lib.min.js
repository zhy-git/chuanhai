...
(function(e) {
	...
	O = function() {
		...
		case "inline":
			...
			e('<div class="fancybox-inline-tmp" />').hide().insertBefore(e(u)).bind("fancybox-cleanup",
			function() {
				e(this).replaceWith(o.children())
				...
				success: function(e, i, a) {
					if (200 == ("object" == typeof a ? a: _).status) {
						if ("function" == typeof g.ajax.win) {
							if (c = g.ajax.win(r, e, i, a), c === !1) return n.hide(),
							void 0; ("string" == typeof c || "object" == typeof c) && (e = c)
						}
						t.html(e),
						L()
					}
	...
	N = function() {
		var d, _;
		if (n.hide(), i.is(":visible") && !1 === v.onCleanup(y, b, v)) e.event.trigger("fancybox-cancel"),
		S = !1;
		else {
			...
			l.hide(),
			i.is(":visible") ? (e(s.add(c).add(u)).hide(), d = i.position(), p = {
				top: d.top,
				left: d.left,
				width: i.width(),
				height: i.height()
			},
			_ = p.width == h.width && p.height == h.height, o.fadeTo(v.changeFade, .3,
			function() {
				var n = function() {
	...
	F = function() { (v.enableEscapeButton || v.enableKeyboardNav) && e(document).bind("keydown.fb",
		function(t) {
	...
	P = function() {
		e.support.opacity || (o.get(0).style.removeAttribute("filter"), i.get(0).style.removeAttribute("filter")),
		...
		v.onComplete(y, b, v);
		var t, n;
		y.length - 1 > b && (t = y[b + 1].href, t !== void 0 && t.match(E) && (n = new Image, n.src = t)),
		b > 0 && (t = y[b - 1].href, t !== void 0 && t.match(E) && (n = new Image, n.src = t))
	},
	B = function(e) {
		var t = {
	...
	j = function() {
		...
		n && (t.width > e[0] || t.height > e[1]) && ("image" == g.type || "swf" == g.type ? (n = v.width / v.height, t.width > e[0] && (t.width = e[0], t.height = parseInt((t.width - r) / n + r, 10)), t.height > e[1] && (t.height = e[1], t.width = parseInt((t.height - r) * n + r, 10))) : (t.width = Math.min(t.width, e[0]), t.height = Math.min(t.height, e[1]))),
	...
	e.fn.fancybox = function(t) {
		return e(this).length ? (e(this).data("fancybox", e.extend({},
		t, e.metadata ? e(this).metadata() : {})).unbind("click.fb").bind("click.fb",
		function(t) {
			t.preventDefault(),
			S || (S = !0, e(this).blur(), f = [], m = 0, t = e(this).attr("rel") || "", t && "" != t && "nofollow" !== t ? (f = e("a[rel=" + t + "], area[rel=" + t + "]"), m = f.index(this)) : f.push(this), O())
		}), this) : this
	},
	e.fancybox = function(t, n) {
		...
		if (!S) {
			if (S = !0, r = n !== void 0 ? n: {},
			f = [], m = parseInt(r.index, 10) || 0, e.isArray(t)) {
				for (var i = 0,
				a = t.length; a > i; i++)"object" == typeof t[i] ? e(t[i]).data("fancybox", e.extend({},
				r, t[i])) : t[i] = e({}).data("fancybox", e.extend({
					content: t[i]
				},
				r));
				f = jQuery.merge(f, t)
			} else "object" == typeof t ? e(t).data("fancybox", e.extend({},
			r, t)) : t = e({}).data("fancybox", e.extend({
				content: t
			},
			r)),
			f.push(t); (m > f.length || 0 > m) && (m = 0),
			O()
		}
	},
...
function(a, n, t) {
	return function(a, n, t, e, i, r) {
		...
		u.options = {
			...
			formattingFn: function(a) {
				...
				if (a = Math.abs(a).toFixed(u.decimals), n = (a += "").split("."), t = n[0], e = 1 < n.length ? u.options.decimal + n[1] : "", u.options.useGrouping) {
					for (i = "", r = 0, o = t.length; r < o; ++r) 0 !== r && r % 3 == 0 && (i = u.options.separator + i),
					i = t[o - r - 1] + i;
					t = i
				}
				return u.options.numerals.length && (t = t.replace(/[0-9]/g,
				function(a) {
		...
		for (var s = 0,
		l = ["webkit", "moz", "ms", "o"], m = 0; m < l.length && !window.requestAnimationFrame; ++m) window.requestAnimationFrame = window[l[m] + "RequestAnimationFrame"],
		window.cancelAnimationFrame = window[l[m] + "CancelAnimationFrame"] || window[l[m] + "CancelRequestAnimationFrame"];
		function d(a) {
		...
		u.reset = function() {
			...
			delete u.startTime,
			u.initialized = !1,
			u.initialize() && (cancelAnimationFrame(u.rAF), u.printValue(u.startVal))
		},
		u.update = function(a) {
