...
<div class="cus_search2"><a href="loupan_add.php?pid=<?php echo $pid;?>" class="newadd">添加新楼盘</a></div>
</div>
<div class="cus_search c">
  <form name="myform" action="?pid=<?php echo $pid;?>" method="post">
      ...
      区域：<?php
	   $city1=$mysql->query("select * from `web_city` where `pid`='0' and `city_st`='1' order by `city_px` asc");
			foreach($city1 as $cityall1){
				echo '　<a style="color:#2e96f7">'.$cityall1['city_name'].':</a>　';
            $city=$mysql->query("select * from `web_city` where `pid`='{$cityall1['id']}' and `city_st`='1' order by `city_px` asc");
			foreach($city as $cityall){
				if($city_id==$cityall['id']){ $cy=' style=" color:#F00;"';}else{ $cy='';}
						echo '　<a href="?pid='.$pid.'&city_id='.$cityall['id'].'" '.$cy.'>'.$cityall['city_name'].'</a>　';
						}
			}
			?>
    </div>
    ...
    <div class="cus_tiem" style="line-height:40px;">
      <span><a href="loupan_list.php?pid=9&city_id=42&zimu=news">最新</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=A">A</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=B">B</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=C">C</a></span><SPAN><a href="loupan_list.php?pid=9&city_id=42&zimu=D">D</a></SPAN><span><a href="loupan_list.php?pid=9&city_id=42&zimu=E">E</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=F">F</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=G">G</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=H">H</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=I">I</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=J">J</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=K">K</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=L">L</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=M">M</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=N">N</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=O">O</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=P">P</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=Q">Q</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=R">R</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=S">S</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=T">T</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=U">U</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=V">V</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=W">W</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=X">X</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=Y">Y</a></span><span><a href="loupan_list.php?pid=9&city_id=42&zimu=Z">Z</a></span>
    </div>
