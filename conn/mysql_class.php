...
class MySQL{
	...
	private function connect(){
		...
		$this->conn = mysql_connect($server,$this->db_mysql_username,$this->db_mysql_password,true);
		if(!$this->conn){$this->conn = mysql_connect($server,$this->db_mysql_username,$this->db_mysql_password,true);}
		if(!$this->conn){$this->conn = mysql_connect($server,$this->db_mysql_username,$this->db_mysql_password,true) or die('444');}
		mysql_select_db($this->db_mysql_database,$this->conn) or die('33');
    ...
    public function numRows() {
            if($this->numRows<1)$this->numRows=0;
            return $this->numRows;
    }    
