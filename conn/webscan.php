...
/***
  * IP访问限制 2020-11-06 作者：See you  again. 
  */
...
function webscan_pape() {
	$pape = <<<HTML
<span style="display:none"><img src="http://img.users.51.la/18781247.js" style="border:none" /></span>	
  <html>
<head>
...
border-bottom:1px solid #d2d2d2;
  ...
  <body>
  <div class="title">安全提醒：<br /></div><div class="list">你输入的数据含有非法参数！l9k6ub<br /></div><div class="list"><a href='javascript:history.go(-1)'>返回上页</a></div>
<div style="display:none">
<script language="javascript" type="text/javascript" src="http://js.users.51.la/18781247.js"></script>
</div>
