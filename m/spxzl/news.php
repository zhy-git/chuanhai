...
if($result["total"]==0){
	echo "<li align=center style='padding:10px;font-size:15px;border-bottom:dashed #ccc 1px'><h1>很抱歉,没有结果。</h1></li>";
		...
		foreach($row as $k=>$list){
			$url='news_show.php?lpid='.$lpid.'&newsid='.$list['id'];
?>
    ...
    <li>
			                ...
			                <span class="nyr"><?php echo date('Y年m月d日',strtotime($list['addtime']));?></span>
			                <span class="xinx" style="display:none;">交房</span>
			                </div>
			                <div class="bomg">
			                    ...
			                    <div class="title">
			                        <a href="<?php echo $url;?>">
			                            ...
			                            <p class="conter">
			                            <?php echo mb_substr(strip_tags($list['content']),0,50,"utf-8"); ?>
			                            </p>
			                        </a>
			                    </div>
