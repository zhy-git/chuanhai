...
.build-intro-wrap .house-tag span{float: left;background: #f2f2f2;color: #999999;margin-right: .1rem;padding: .1rem .15rem;border-radius: 3px;}
        ...
        <div class="zh_housecon-pic-img lincss"> 
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="Tceng">
                                    <video id="cideoPlay1" width="100%" height="400px" controls poster="/<?php echo $infos['src8'];?>" webkit-playsinline="tes"  preload="none"> 
            ...
            <div class="lp_pic">
                <a href="javascript:;" title='【<?php echo cityname($infos['city_id']);?>】<?php echo $infos['title'];?>'>
                    <i></i>
                    <span>1/<?php echo countxc('all',$lpid);?></span>
                </a>
            </div>
...
.house-info-c1 .link-area li .icon-notice{background: url(/public/static/phone/img/icons/zoushi.jpg) no-repeat;padding: .2rem;background-size: 16px 14px;}
.house-info-c1 .link-area li .icon-msg{background: url(/public/static/phone/image/tongzhi.png) no-repeat 0px 0px;padding: .24rem;background-size: 17px 14px;}
...
.house-info-c .link-area li a{display:block;color:#888888;text-align:center;font-size:.3733rem;box-sizing:border-box;width:100%;height:1.22rem;line-height:1.2rem;background-color:#f3f6f9;border-radius:.10667rem;overflow:hidden}
...
.house-yyin .pic img {width: 1rem;height: 1rem;border-radius: 50%;}
...
<script>
    ...
    var mycars=new Array(<?php if($infos['src7']<>''){ echo '"视频",';}?>"图片");
...
<!-- 轮播 end-->
    ...
    <div class="house-nav1 htop1" style="margin-top: 0;">
        <ul class="house-nav-navh">
            ...
            <li><a href="/m/loupan/huxing/<?php echo $lpid;?>.html"><p>户型</p></a></li>
            <li class="act"><a href="/m/loupan/zb/<?php echo $lpid;?>.html"><p>配套</p></a></li>
            <li class="last-wrap"><a href="/m/loupan/wenda/<?php echo $lpid;?>.html"><p>问答</p></a></li>
        </ul>
    </div>
    <div class="rows" style="padding: 0 .15rem">
        <div class="build-intro-wrap">        
            <a href="/m/loupan/tgbm/<?php echo $lpid;?>.html" class="btn-ljtg btn-dynamic">
                <img src="/public/static/phone/img/icons/team9.png" class="icons-sm-team">
			...
			?></span>
                 <span class="bm" style="display: none;"><b><?php echo (int)$infos['esfcx'];?></b>人已报名</span>
            </div>
            <div class="house-tag">
            ...
            <div class="blank10"></div>
                ...
                <div class="hui-txt">
                    <p class="txt-1"><?php echo $infos['fkfs'];?></p>
                                        <p class="txt-2">距离结束剩余<span class="txt-color1"><?php echo date("t")-date("d");?></span>天  <span class="txt-color1"><?php echo (int)$infos['esfcx'];?></span>人已报名</p>
                </div>
        ...
        <div class="house-info-c" style="height: auto;">
            ...
            <div class="house-info-c1">
                ...
                <div class="house-yyin">                    
                    ...
                    <div class="yyin fl">
                        <span class="y-1">楼盘详情在线讲房</span><span class="y-2"><?php echo (int)$infos['esfcx'];?>人听过</span>
                    </div>                                        
                    <div class="clear"></div>
                </div> 
                </a>
                ...
                <ul class="link-area">
                    ...
                    <li>
                        <a href="javascript:;" data-id="<?php echo $lpid;?>" data-name="<?php echo $infos['title'];?>" onclick="openwid4('开盘通知我','输入您的手机号码，免费订阅楼盘开盘提醒，不再错失好房源。','【<?php echo cityname($infos['city_id']);?>】<?php echo $infos['title'];?>楼盘手机内页_开盘通知我',3);" style="width: 4.18rem;">
...
<?php
		...
		?> 	
            ...
            <div style="height: 12px"></div>
                ...
                <div class="pic fl"><img src="/<?php echo $gws[0]['img'];?>"></div>
                <div class="fl mt5">
...
?>      	     
    ...
    <input type="hidden" name="ly" value="【<?php echo cityname($infos['city_id']);?>】<?php echo $infos['title'];?>_前往领取" id="make_tit_4">
...
?>      				
    ...
    <div class="rows" style="padding: 0 .15rem">
        <div class="lqsp-box" style="border-radius: 5px;background: #fff url(/public/static/phone/img/video.jpg) no-repeat 5px;background-size: 40px 40px;">
             ...
             <p style="position: absolute;right: 6px;top: 38px;">已有<?php echo (int)$infos['esfcx'];?>人领取</p>
		...
		?>
                     <li style="width: 145px;">
                       <a href="/m/loupan/photo/<?php echo $lpid;?>_<?php echo $list['id'];?>.html" style="display: block;">
                            ...
                            <div class="txt"><p><?php echo $list['pic_name'];?></p></div>
                        </a>
                    </li>   
<?php
			}
