...
<style type="text/css">
    ...
    .popBox{background:#fff;border-radius:5px;width:80%;height:285px;-moz-box-shadow:0 0 10px 5px #f3bc5f75;-webkit-box-shadow:0 0 10px 5px #4e4d75;box-shadow:0 0 10px 5px #4e4d75}
    .popBox .close{position:absolute;right:50%;bottom:-49px;background:#fff;height:36px;width:36px;border-radius:50%;margin-right: -18px;}
    ...
    .popBox .textBox{overflow-y:auto;height:155px}
...
<div class="a-footer-layer">
    <div class="shou3-box c">
        ...
        <div class="shou3-list2">
            <a rel="nofollow" onclick="openwid4('组团砍价','我们将为您保密个人信息！为您提供楼盘免费预约专车看房服务！','【<?php echo cityname($infos['city_id']);?>】<?php echo $infos['title'];?>_底部漂浮组团砍价',2);"  style="background: #fd800b">组团砍价</a></div>
        <div class="shou3-list2">
            <a href="javascript:phone('<?php echo telsee($infos['loupan_tel']);?>',2)" rel="nofollow" style="background: #fc0e08" data-agl-cvt="2">售楼处电话</a>
        </div>
    </div>
</div>
