...
//区域，价格，户型  参数选择点击事件
//     $('.query-panel ul.area-type-item li,.query-panel ul.price-item li,.query-panel ul.housetype-item li').click(function(){
//         click_close($(this));
//
//     });
    ...
    $('.query-mnore .query-panel .btn-area2').children('.btn-confirm').click(function(){
        ...
        if(search_arr.length > 0){
            ...
            if(type==1){
                ...
                window.location.href = commonLocation(site_url,'lp/list'+cityid+'_'+priceid+'_'+hxid+'_'+search_str+'.html');
            }else{
...
$('.sizetype ul').width($('.sizetype li').size()*120);
